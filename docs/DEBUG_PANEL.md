...
- **Профилирование запросов**: `Debug::setProfilingEnabled(true/false)` - включает/отключает сбор SQL запросов
- **Исключение служебных запросов**: `Debug::setExcludeAnalysisQueries(true/false)` - исключает служебные запросы анализа из SQL вкладки
- **Порог медленных запросов**: `Debug::setSlowQueryThreshold(1000)` (в миллисекундах)
- **Лимиты памяти**: `Debug::setMaxPerformanceEntries(500)`, `Debug::setMaxExecutionsPerQuery(50)`
...
- **Настройки профилирования** - информация о включенном/отключенном профилировании
- **Исключение служебных запросов** - автоматическое исключение запросов анализа (SELECT VERSION, SHOW TABLES, EXPLAIN и др.)
...
Debug::setProfilingEnabled(true);  // Включить профилирование SQL запросов
Debug::setExcludeAnalysisQueries(true);  // Исключить служебные запросы из SQL вкладки
Debug::setSlowQueryThreshold(100);  // Порог медленных запросов: 100ms
