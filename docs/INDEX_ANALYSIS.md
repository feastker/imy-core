...
### Ограничения анализа производительности

1. **Память** - данные хранятся в памяти, могут занимать много места при большом количестве запросов
...
### UNION запрос (улучшенный парсер)
```sql
